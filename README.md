...
I'll be using Google ecosystem as my database instead of something complex like SQL. My current business database were kept in Google through a webapp for years with thousand of records which is free and no monthly software subcription fees. 
