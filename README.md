...
I'll be using Google ecosystem as my database instead of something complex like SQL. My current business database were kept in Google through a webapp for years with thousand of records which is free and no monthly software subcription fees. Now I'm extending my existing concept to work better than before, which is basically uncommon, that I'm forcing a non-SaaS platform to behave like a SaaS backend. (most people use as simple CRUD app / single company automation only).
